...
mcmc.odesim <- function(
  ...
  lik.home.deaths = FALSE,      # evaluate likelihood for age-struc. new deaths and total new deaths (default = FALSE)
  lik.hosp.deaths = FALSE,      # evaluate likelihood for age-struc. new deaths and total new deaths (default = FALSE)
  lik.hosp.discharges = FALSE,  # evaluate likelihood for age-struc. new deaths and total new deaths (default = FALSE)
